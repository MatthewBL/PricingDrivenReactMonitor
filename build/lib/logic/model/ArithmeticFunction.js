...
var ArithmeticFunction = (function () {
    function ArithmeticFunction(left, right, operator) {
        this.left = left;
        this.right = right;
        this.op = operator;
    }
    ArithmeticFunction.prototype.eval = function (options) {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (lEval.isError || rEval.isError) {
                            return [2, (0, ResultValue_1.error)("Error evaluating Arithmetic Expression: " +
                                    lEval.errorMessage +
                                    " " +
                                    rEval.errorMessage)];
                        }
                        ...
                        if (val === undefined) {
                            return [2, (0, ResultValue_1.error)("Error evaluating Arithmetic Expression: Invalid arithmetic operator " +
                                    this.op)];
                        }
